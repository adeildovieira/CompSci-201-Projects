 ...
 */
 ...
 public class Person201 {
    ...
    /** 
     * Fixed! Now, it returns true only if other has the
     * same building AND the same floor. (Text changed by the student)
    */
    public boolean sameFloor(Person201 other) {
        if (sameBuilding(other) && myFloor == other.myFloor) {
            return true;
        }
        return false;
    }
